...
class ADAFeatures implements Serializable{
    private TreeNode hasQ(ArrayList<String[]> trainingData) {
        ...
        TreeNode treeNode = new TreeNode(yesData, noData,"A", impurity, yesLabel==null? null:new TreeNode(yesLabel), noLabel==null? null:new TreeNode(noLabel), maxYes, maxNo);
        treeNode.setErrorSampleWeights(errorSampleWeights);
        return treeNode;
    }
    ...
    private TreeNode hasDe(ArrayList<String[]> trainingData) {
        ...
        TreeNode treeNode = new TreeNode(yesData, noData,"B",impurity, yesLabel==null? null:new TreeNode(yesLabel), noLabel==null? null:new TreeNode(noLabel), maxYes, maxNo);
        treeNode.setErrorSampleWeights(errorSampleWeights);
        return treeNode;
    }
    ...
    private TreeNode lengthOfWordGreaterThan12(ArrayList<String[]> trainingData) {
        ...
        TreeNode treeNode = new TreeNode(yesData, noData,"C", impurity, yesLabel==null? null: new TreeNode(yesLabel), noLabel==null? null:new TreeNode(noLabel), maxYes, maxNo);
        treeNode.setErrorSampleWeights(errorSampleWeights);
        return treeNode;
    }
    ...
    private TreeNode lettersRepeatedMoreThanOnce(ArrayList<String[]> trainingData) {
        ...
        TreeNode treeNode = new TreeNode(yesData, noData,"D", impurity, yesLabel==null? null:new TreeNode(yesLabel), noLabel==null? null:new TreeNode(noLabel), maxYes, maxNo);
        treeNode.setErrorSampleWeights(errorSampleWeights);
        return treeNode;
    }
    ...
    private TreeNode hasEnAn(ArrayList<String[]> trainingData) {
        ...
        TreeNode treeNode = new TreeNode(yesData, noData,"E",impurity, yesLabel==null? null:new TreeNode(yesLabel), noLabel==null? null:new TreeNode(noLabel), maxYes, maxNo);
        treeNode.setErrorSampleWeights(errorSampleWeights);
        return treeNode;
    }
    ...
    private TreeNode hasThe(ArrayList<String[]> trainingData) {
        ...
        TreeNode treeNode = new TreeNode(yesData, noData,"F", impurity, yesLabel==null? null:new TreeNode(yesLabel), noLabel==null? null:new TreeNode(noLabel), maxYes, maxNo);
        treeNode.setErrorSampleWeights(errorSampleWeights);
        return treeNode;
    }
